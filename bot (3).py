...
async def buy_receive_screenshot(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        f"Order #{order_id} — you'll receive your download link here as soon as it's approved.\n\n"
...
async def admin_add_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    return await _prompt_for_drive_link(update, context)
...
async def _prompt_for_drive_link(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
